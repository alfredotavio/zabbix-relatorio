...
$stringData = "1<Introdução>\n\n";
fwrite($fh, $stringData);
$stringData = "Arquivo PDF gerado pelo Sistema de monitoramento Zabbix.\n";
fwrite($fh, $stringData);
$stringData = "#NP\n";
fwrite($fh, $stringData);
#$stringData = "1<Graphs>\n";
...
$pdf->ezText("Relatório Zabbix",(40-strlen($company_name)),array('justification'=>'centre'));
